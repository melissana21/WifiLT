...
public class readNodeInfo {
    public static void main(int node_ID, Context myContext) throws IOException{
        ...
        String NodeInfo = myContext.getExternalFilesDir(null).getAbsolutePath() + declaration.Storage_Directory + s + "/" + declaration.NodeInfo_FileName + declaration.NodeInfo_extension;
